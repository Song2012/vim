...
"
	...
	"===============================================================================================
	"
	exe "amenu  <silent>  ".s:MenuRun.'.save\ and\ &compile<Tab>\\rc\ \ \<F9\>         :call C_Compile()<CR>:call C_HlMessage()<CR>'
	exe "imenu  <silent>  ".s:MenuRun.'.save\ and\ &compile<Tab>\\rc\ \ \<F9\>    <C-C>:call C_Compile()<CR>:call C_HlMessage()<CR>'
